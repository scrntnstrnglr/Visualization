...
public class VisualizerSettings {
	...
	public static final int SCREEN_WIDTH = 820, SCREEN_HEIGHT = 930, MINARD_SCREEN_WIDTH = 1900,
			MINARD_SCREEN_HEIGHT = 950;
	private static final String MAPBOX_API_KEY="mapbox://styles/bhattasi/ck6l7ho2s0pu11ip7xrk3vbde";
	public static final TonerLite MAP_PROVIDER = new StamenMapProvider.TonerLite();
